...
@APICommand(name = "deleteLBHealthCheckPolicy", description = "Deletes a LB HealthCheck policy.", responseObject = SuccessResponse.class, since="4.1.0")
public class DeleteLBHealthCheckPolicyCmd extends BaseAsyncCmd {
    ...
    private static final String s_name = "deleteLBHealthCheckruleresponse";
    // ///////////////////////////////////////////////////
    // ////////////// API parameters /////////////////////
    // ///////////////////////////////////////////////////

    @Parameter(name = ApiConstants.ID, type = CommandType.UUID, entityType = LBStickinessResponse.class,
            required = true, description = "the ID of the LB HealthCheck policy")
    private Long id;
    ...
    public Long getSyncObjId() {
        HealthCheckPolicy policy = _entityMgr.findById(HealthCheckPolicy.class,
                getId());
        if (policy == null) {
            throw new InvalidParameterValueException("Unable to find LB healthcheck rule: " + id);
        }
