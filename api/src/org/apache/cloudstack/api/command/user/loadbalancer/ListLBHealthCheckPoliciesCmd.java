...
@APICommand(name = "listLBHealthCheckPolicies", description = "Lists LBHealthCheck policies.", responseObject = LBHealthCheckResponse.class, since="4.1.0")
public class ListLBHealthCheckPoliciesCmd extends BaseListCmd {
    ...
    private static final String s_name = "listlbhealtcheckpoliciesresponse";
